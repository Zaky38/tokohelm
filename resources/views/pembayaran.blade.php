...
<div class="payment-card">
    ...
    <!-- BRAND -->
    <div class="brand">
        <img src="{{ asset('images/helmlogo.png') }}" alt="logo">
    </div>
    ...
    @if($pesanan->metode_pembayaran == 'bca')
        1234567890

    @elseif($pesanan->metode_pembayaran == 'bri')
        9876543210

    @elseif($pesanan->metode_pembayaran == 'mandiri')
        555666777
    ...
    @endif
        ...
        <!-- BUTTON -->
        <form action="{{ url('pembayaran/' . $pesanan->id) }}"
        method="POST"
